...
# }
DATABASES ={
    'default':dj_database_url.parse('postgres://new_do76_user:qWBjNjyCpdhfrPbH1MHXtT1v7IIDZHqh@dpg-cocgl963e1ms73b3qqeg-a.singapore-postgres.render.com/new_do76')
}
